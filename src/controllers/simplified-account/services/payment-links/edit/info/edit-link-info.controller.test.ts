...
const { nextRequest, call, res } = new ControllerTestBuilder(
  '@controllers/simplified-account/services/payment-links/edit/info/edit-link-info.controller'
)
  .withStubs({
...
describe('controller: services/payment-links/edit/info/edit-link-info', () => {
    ...
    describe('with valid product', () => {
      ...
      it('should pass correct template path to the response method', () => {
        sinon.assert.calledWith(
          ...
          sinon.match.any,
          sinon.match.any,
          'simplified-account/services/payment-links/edit/info'
        )
      })
      ...
      it('should set form values in context', () => {
        ...
        sinon.assert.match(formValues.name, 'Test Payment Link')
        sinon.assert.match(formValues.description, 'Test Description')
      })
  ...
  describe('post', () => {
    ...
    describe('with empty description', () => {
      ...
      it('should allow empty description and redirect', () => {
        const expectedProductUpdateRequest = ProductUpdateRequestBuilder.fromProduct(mockProduct)
          .setName('Valid name')
          .setDescription('')
          .build()
