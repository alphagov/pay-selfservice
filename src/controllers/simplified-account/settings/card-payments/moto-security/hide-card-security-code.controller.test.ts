...
const { req, res, nextRequest, call } = new ControllerTestBuilder(
  '@controllers/simplified-account/settings/card-payments/moto-security/hide-card-security-code.controller'
)
  .withAccount({
    type: ACCOUNT_TYPE,
    allowMoto: true,
  ...
  describe('post', () => {
    describe('valid submission', () => {
      ...
      it('should call updateMotoMaskSecurityCode', () => {
        sinon.assert.calledOnceWithExactly(mockUpdateMotoMaskSecurityCode, SERVICE_EXTERNAL_ID, ACCOUNT_TYPE, false)
      })
