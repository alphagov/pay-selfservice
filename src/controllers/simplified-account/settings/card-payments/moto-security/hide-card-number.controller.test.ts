...
const { req, res, nextRequest, call } = new ControllerTestBuilder(
  '@controllers/simplified-account/settings/card-payments/moto-security/hide-card-number.controller'
)
  .withAccount({
    type: ACCOUNT_TYPE,
    allowMoto: true,
  ...
  describe('post', () => {
    describe('valid submission', () => {
      ...
      it('should call updateMotoMaskCardNumber', () => {
        sinon.assert.calledOnceWithExactly(mockUpdateMotoMaskCardNumber, SERVICE_EXTERNAL_ID, ACCOUNT_TYPE, true)
      })
