...
describe('Controller: settings/webhooks', () => {
  describe('get', () => {
    ...
    it('should pass context data to the response method', () => {
      expect(mockResponse.args[0][3]).to.have.property('webhooks').to.have.length(1)
      expect(mockResponse.args[0][3].webhooks[0]).to.have.property('callback_url').to.equal('https://www.callback-url.gov.uk')
