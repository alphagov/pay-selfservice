...
const GatewayAccountCredential = require('@models/gateway-account-credential/GatewayAccountCredential.class').default
const WorldpayCredential = require('@models/gateway-account-credential/WorldpayCredential.class').default
const Credential = require('@models/gateway-account-credential/Credential.class').default
