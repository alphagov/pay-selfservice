...
module.exports = {
  get: [checkTaskCompletion(StripeTaskIdentifiers.DIRECTOR.connectorName), get],
  post: [checkTaskCompletion(StripeTaskIdentifiers.DIRECTOR.connectorName), post]
}
