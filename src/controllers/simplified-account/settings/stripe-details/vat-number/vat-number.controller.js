...
module.exports = {
  get: [checkTaskCompletion(StripeTaskIdentifiers.VAT_NUMBER.connectorName), get],
  post: [checkTaskCompletion(StripeTaskIdentifiers.VAT_NUMBER.connectorName), post]
}
