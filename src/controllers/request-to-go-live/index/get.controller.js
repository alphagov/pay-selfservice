...
const agreedToTerms = [TERMS_AGREED_ADYEN, TERMS_AGREED_STRIPE, TERMS_AGREED_GOV_BANKING_WORLDPAY, ...live]
...
const enteredOrganisationAddress = [ENTERED_ORGANISATION_ADDRESS, ...chosenHowToProcessPayments]

const enteredOrganisationName = [ENTERED_ORGANISATION_NAME, ...enteredOrganisationAddress]
...
const showNextSteps = [TERMS_AGREED_ADYEN, TERMS_AGREED_STRIPE, TERMS_AGREED_GOV_BANKING_WORLDPAY]

const pspIsStripe = [CHOSEN_PSP_STRIPE, TERMS_AGREED_STRIPE]

const pspIsAdyen = [CHOSEN_PSP_ADYEN, TERMS_AGREED_ADYEN]
...
module.exports = (req, res) => {
  ...
  pageData = {
    ...
    pspIsAdyen: pspIsAdyen.includes(currentGoLiveStage),
    takesPaymentsOverPhone:
      currentGoLiveStage === TERMS_AGREED_GOV_BANKING_WORLDPAY && req.service.takesPaymentsOverPhone,
  }
