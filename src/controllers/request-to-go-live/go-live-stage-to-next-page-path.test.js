...
describe('go-live-stage-to-next-page-path tests', () => {
  describe('should return "index" path', () => {
    ...
    it('should resolve TERMS_AGREED_ADYEN stages correctly', () => {
      expect(goLiveStageToNextPagePath[goLiveStage.TERMS_AGREED_ADYEN]).to.equal(path)
    })
  ...
  describe('should return "agreement" path', () => {
    ...
    it('should resolve CHOSEN_PSP_ADYEN stages correctly', () => {
      expect(goLiveStageToNextPagePath[goLiveStage.CHOSEN_PSP_ADYEN]).to.equal(path)
    })
