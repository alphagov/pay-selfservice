 ...
 */
async function updateOneOffCustomerInitiatedCredential (serviceExternalId, accountType, credentialId, userExternalId, credential) {
...
module.exports = {
  ...
  updateOneOffCustomerInitiatedCredential,
