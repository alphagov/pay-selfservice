...
module.exports = function (req, data, template) {
  ...
  if (permissions) {
    ...
    convertedData.adminNavigationItems = adminNavigationItems(currentPath, permissions, paymentMethod, paymentProvider, account, service, req.currentAccountPrototype)
  }
