...
module.exports = (req, res) => {
  if (lodash.has(req, 'file.buffer')) {
    const fileTypeInformation = fileType(req.file.buffer)
    ...
    console.log('fileTypeInformation:')
    console.log(JSON.stringify(fileTypeInformation))
    if (!allowedMimetypes.includes(fileTypeInformation.mime)) {
      return responses.renderErrorView(req, res, 'Invalid Image')
    }
