...
function showOrganisationDetails (req, res) {
  ...
  if (!merchantDetails ||
    ...
    return res.redirect(formatServicePathsFor(paths.service.organisationDetails.edit, externalServiceId))
  }

  const pageData = {
    merchant_details: merchantDetails,
    externalServiceId,
    editPath: formatServicePathsFor(paths.service.organisationDetails.edit, externalServiceId)
  }
