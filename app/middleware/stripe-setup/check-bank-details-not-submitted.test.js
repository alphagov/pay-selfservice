...
describe('Check bank details not submitted middleware', () => {
  ...
  it(
    'should redirect to the dashboard with error message when bank account flag is true',
    async () => {
  ...
  it(
    'should render an error page when req.account.connectorGatewayAccountStripeProgress',
    async () => {
