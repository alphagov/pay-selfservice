...
class MockClient {
  ...
  async get (url, description) {
    ...
    if (url.match(/\.*\/event/)) { dataResponse = ledgerTransactionEventsFixture } else if (url.match(/\/transaction\//)) dataResponse = { validCreatedTransactionDetailsResponse }
    else if (url.match(/\/report\/transactions-summary/)) { dataResponse = validTransactionSummaryResponse } else if (url.match(/\/agreement/)) dataResponse = { validTransactionSummaryResponse }
    else if (url.match(/\/payout/)) dataResponse = {}
    else if (url.match(/\/transaction\?account_id.*limit_total/)) { dataResponse = validTransactionSearchResponse } else dataResponse = {}
