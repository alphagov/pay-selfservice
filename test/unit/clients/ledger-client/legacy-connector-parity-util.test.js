...
describe('Ledger service client legacy parity utilities', () => {
  describe('Transaction parity', () => {
    it(
      'Correctly maps fields from expected ledger values to current connector names',
      () => {
    ...
    it(
      'Correctly maps ledger values on refund parent transaction to current connector names',
      () => {
        const ledgerTransactionFixture = {
          transaction_id: 'some-transaction-id',
  ...
  describe('Event parity', () => {
    ...
    it(
      'Only maps refunded by values if the event contains user refunded details',
      () => {
  ...
  describe('Transactions parity', () => {
    it(
      'Applies transaction parity to the result set of a search response',
      () => {
  ...
  describe('Transaction Summary parity', () => {
    it(
      'Applies transaction summary to the result set of a transaction summary response',
      () => {
