...
describe('date format', () => {
  ...
  it(
    'should return the fromDate correctly formatted for the api',
    () => {
  ...
  it(
    "should return a null response for an invalid 'fromDate' format",
    () => {
      assert.strictEqual(null, dates.fromDateToApiFormat('11-11/1981'))
    }
  )

  it('should return the toDate correctly formatted for the api', () => {
  ...
  it(
    "should return a null response for an invalid 'toDate' format",
    () => {
      assert.strictEqual(null, dates.toDateToApiFormat('11-11/1981'))
    }
  )

  it('should return the valid default format', () => {
    assert.strictEqual('2016-01-29 17:24:48', dates.dateToDefaultFormat('2016-01-29T17:24:48Z'))
  })

  it('should return the valid default format in bst', () => {
