...
describe('isNotValidAccountNumber', () => {
  it('should validate successfully for 8 digits', () => {
    ...
    expect(isNotAccountNumber(accountNumber)).toBe(false) // eslint-disable-line
  })
  ...
  it('should be not valid when is not a number', () => {
    ...
    expect(isNotAccountNumber(accountNumber)).toBe('Enter a valid account number like 00733445')
  })
