...
describe('date format', function () {
  ...
  it("should return an error message for an invalid 'fromDate' format",function() {
    assert.equal("Invalid date",dates.fromDateToApiFormat("11-11/1981"));
  });
  ...
  it("should return an error message for an invalid 'toDate' format",function() {
    assert.equal("Invalid date",dates.toDateToApiFormat("11-11/1981"));
  });
