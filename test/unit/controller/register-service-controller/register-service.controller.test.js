...
jest.mock('../services/service-registration.service', () => ({
...
describe('Register service', () => {
  ...
  const controllerWithStubbedAdminusersSuccess = require('../../../../app/controllers/register-service.controller.js')
  ...
  it(
    'should redirect to the registration submitted page when successful',
    async () => {
  ...
  it(
    'should redirect with error stating email has to be a public sector email when adminusers responds with a 403',
    async () => {
  ...
  it(
    'should continue to confirmation page when adminusers returns a 409',
    async () => {
      const errorFromAdminusers = {
        errorCode: 409
      }
  ...
  it(
    'should redirect with error whan an invalid phone number is entered',
    async () => {
  ...
  it(
    'should show error page for unexpected error from adminusers',
    async () => {
      const error = {
        errorCode: 404
      }
