...
describe('Edit payment link amount', () => {
  ...
  before(done => {
    ...
    supertest(createAppWithSession(getApp(), session))
      .get(formattedPathFor(paths.paymentLinks.editAmount, PRODUCT_EXTERNAL_ID))
  ...
  it('should display the correct page links', () => {
    ...
    expect(response.body).to.have.property('self', formattedPathFor(paths.paymentLinks.editAmount, PRODUCT_EXTERNAL_ID))
  })
