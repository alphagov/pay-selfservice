  ...
  describe('When switching to Stripe', () => {
    describe('Switching page', () => {
      ...
      it('shows Stripe specific tasks', () => {
        ...
        cy.get('strong[id="Upload proof of government entity document-status"]').should('contain', 'not started')
        cy.get('span').contains('Upload proof of government entity document').should('exist')
    ...
    describe('Switch page unlocks appropriately', () => {
      ...
      it('all steps are complete', () => {
        ...
        cy.get('strong[id="Upload proof of government entity document-status"]').should('contain', 'completed')
