...
const { STRIPE_CREDENTIAL_IN_ACTIVE_STATE, WORLDPAY_CREDENTIAL_IN_ENTERED_STATE, WORLDPAY_CREDENTIAL_IN_CREATED_STATE } = require('@test/fixtures/credential-states')
