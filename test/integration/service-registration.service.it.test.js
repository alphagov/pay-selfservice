...
describe('create populated service', function () {
  ...
  it('should create a sandbox gateway account and complete invite successfully', function () {
  ...
  it('should error if creation of a gateway account failed', function () {
    const inviteCode = 'a-valid-invite-code'
  ...
  it('should error if creation of a gateway account succeeded and complete invite succeeded, but user already exists', function () {
    const inviteCode = 'a-valid-invite-code'
    const gatewayAccountId = '1'
