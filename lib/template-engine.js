...
var staticify = require('../server.js').staticify
...
TemplateEngine.__express = function (templatePath, templateData, next) {
  ...
  templateData.cssPath = nodeEnv === 'production' ? CSS_PATH : staticify.getVersionedPath('/stylesheets/application.css')
  templateData.jsPath = nodeEnv === 'production' ? JAVASCRIPT_PATH : staticify.getVersionedPath('/js/application.js')
